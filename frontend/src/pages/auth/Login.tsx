        ...
        <Card 
          ...
          title={
            <div style={{ textAlign: 'center', width: '100%', marginBottom: '10px' }}>
              <h2 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#fff', letterSpacing: '-0.5px' }}>Welcome Back</h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '5px' }}>
                Sign in to manage your ESG contributions
              </p>
            </div>
          }
        >
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <Button type="submit" disabled={loading} style={{ padding: '12px', fontSize: '0.95rem' }}>
